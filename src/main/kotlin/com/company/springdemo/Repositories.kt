...
interface TransactionItemRepository:BaseRepository<TransactionItem>{
    fun findAllByTransactionUserId(pageable: Pageable,userId: User):Page<TransactionItem>
    fun findAllByTransaction(transaction:Transaction,pageable: Pageable):Page<TransactionItem>
}
interface UserPaymentTransactionRepository:BaseRepository<UserPaymentTransaction>{
    fun findAllByUserIdAndDeletedFalse(userId: User,pageable: Pageable):Page<UserPaymentTransaction>
}